...
metadata:
  ...
  layout: "scripts/ (adapters.py artifacts.py devloop.sh DevLoop.ps1 devloop_worker.py devloop_mcp.py agy_host.sh goal.py research.py review.py ship.py triage.py contracts.py verify_harness.py install.sh install.ps1) references/ (harness-adapters.md artifacts.md goal.md research.md review.md ship.md triage.md) assets/ (lane-schema.json openai-tools.json lanes.example.json lanes.agy-manager.example.json templates/)"
